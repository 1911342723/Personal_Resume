# 虚拟摇杆按钮，继承自 TouchScreenButton，用于移动控制
extends TouchScreenButton

const DRAG_RADIUS := 16.0  # 摇杆最大拖动半径

var finger_index := -1  # 当前按下的手指编号
var drag_offset: Vector2  # 拖动偏移量

@onready var rest_pos := global_position  # 摇杆初始位置
